...
real :: C_d = 0.0015, U = 5.0, Newton_error = 0.0001, Balance_error = 1.0, pi = 3.14159265, solution_error = 100, iterations = 0.0, max_iterations = 5000.0, iteration_step = 1, acceptable_error = 0.8
