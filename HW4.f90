...
real :: pressures(3), p1 = 0.1e5, p2 = 1e5, p3 = 10e5, R_N2 = 296.8, sigma = 5.67e-8, alpha = 0.2, e_a = 0.8, C_p = 1040, C_d = 0.0015, U = 5.0, Newton_error = 0.0001, Balance_error = 1.0, pi = 3.14159265, solution_error = 100
integer :: i, j, k, t, p, iterations = 0, max_iterations = 10000, no_solution_flag = 0
...
do p = 1, 3
    ...
    do while(solution_error > 1.0)
        ...
        do k = 2, 181
            ...
            RHS = (((1.0 - e_a)*sigma*Ts_current**4 + e_a * sigma * T_a**4) * cos(theta(k))) * d_theta
            sum = sum + RHS
        enddo
    ...
    if (no_solution_flag == 0) then
        ...
        write(20, *) "Atmospheric temperature found at pressure value of 0.1 bars = ", T_a
        write(20, *) 
...
do p = 1, 3
    ...
    if (no_solution_flag == 0) then
        ...
        write(30, *) "Atmospheric temperature found at pressure value of 0.1 bars = ", T_a
        write(30, *) 
